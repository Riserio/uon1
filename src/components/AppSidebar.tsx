import { LayoutDashboard, Building2, Users, UserCircle, UsersRound, Calendar, LogOut, Megaphone, Settings, FileText, MessageCircle, ClipboardList, Camera, FileX, AlertTriangle, Mail } from 'lucide-react';
...
import { Sidebar, SidebarContent, SidebarGroup, SidebarGroupContent, SidebarGroupLabel, SidebarMenu, SidebarMenuButton, SidebarMenuItem, SidebarTrigger, useSidebar, SidebarSeparator, SidebarFooter, SidebarHeader } from '@/components/ui/sidebar';
          ...
          <SidebarGroup>
            ...
            <SidebarGroupContent>
              <SidebarMenu>
                ...
                {(userRole === 'admin' || userRole === 'administrativo' || userRole === 'superintendente') && <SidebarMenuItem>
                    <SidebarMenuButton asChild>
                      <NavLink to="/usuarios" activeClassName="bg-primary text-primary-foreground">
                        <div className="flex items-center justify-between w-full">
                          ...
                          {!collapsed && pendingUsers > 0 && <Badge variant="destructive" className="ml-auto">
                              {pendingUsers}
                            </Badge>}
                        </div>
                      </NavLink>
          ...
          <SidebarGroup>
            ...
            <SidebarGroupContent>
              <SidebarMenu>
                ...
                {(userRole === 'admin' || userRole === 'superintendente') && <SidebarMenuItem>
                  <SidebarMenuButton asChild>
