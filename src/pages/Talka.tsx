                  ...
                  <CardContent className="p-4">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex items-center gap-1.5 flex-shrink-0">
                        ...
                        <Button size="sm" variant="outline" onClick={() => salvarNoGoogle(reuniao)} title="Salvar na agenda Google">
                          <CalendarPlus className="h-3.5 w-3.5" />
                        </Button>
                        <Button size="sm" variant="outline" onClick={() => openEditDialog(reuniao)} title="Editar">
                          <ExternalLink className="h-3.5 w-3.5" />
                        </Button>
                        <Button size="sm" variant="ghost" onClick={() => handleDelete(reuniao.id)} className="text-destructive hover:text-destructive">
                ...
                <Card key={reuniao.id} className="opacity-70">
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Button size="sm" variant="ghost" onClick={() => handleDelete(reuniao.id)} className="text-destructive">
                        <Trash2 className="h-3.5 w-3.5" />
                      </Button>
                    </div>
                  </CardContent>
        ...
        <ResponsiveDialogContent className="max-w-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end gap-2 pt-2">
              ...
              <Button type="submit">
                {editingReuniao ? 'Salvar' : 'Criar Reunião'}
              </Button>
            </div>
          </form>
