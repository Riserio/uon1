...
export default function LancamentosFinanceiros() {
  ...
  const handleApproval = async () => {
    ...
    try {
      ...
      toast.success(
        approvalAction === "aprovar" ? "Lançamento aprovado!" : "Lançamento rejeitado!"
      );
    ...
    <div className="p-6 space-y-6">
                    ...
                    <div className="flex gap-2">
                      ...
                      {lancamento.status === "aprovado" && userRole === "superintendente" && (
                        <Button
                          size="sm"
                          variant="ghost"
                          onClick={() => handleMarcarPago(lancamento)}
                        >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-semibold text-lg">
                    {formatCurrency(selectedLancamento.valor_liquido)}
                  </p>
                </div>
                <div>
      ...
      <Dialog open={approvalDialogOpen} onOpenChange={setApprovalDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {approvalAction === "aprovar" ? "Aprovar Lançamento" : "Rejeitar Lançamento"}
            </DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            {selectedLancamento && (
