...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      // z-[100000] — a sidebar fixa usa z-[60] (e z-[120] no mobile), então o
      // overlay/conteúdo de qualquer modal precisa ficar acima disso em todas
      // as telas (mesmo padrão já usado em popover.tsx para esse mesmo bug).
