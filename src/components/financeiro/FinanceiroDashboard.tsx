...
export default function FinanceiroDashboard({ corretoraId }: Props) {
  ...
  return (
    <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Ticket médio: {formatCurrency(kpis.ticketMedioReceita)}
                </p>
              </div>
          ...
          <CardContent className="p-5">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Ticket médio: {formatCurrency(kpis.ticketMedioDespesa)}
                </p>
              </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        {/* Composed Chart - Receitas vs Despesas */}
