...
const DEFAULT_MAPS: Record<string, string[]> = {
    ...
    // RESUMO GERAL consolidado — todas as tags disponíveis (Eventos + Cobrança + MGF).
    // A ordem abaixo é o mapeamento padrão {{1}}..{{n}}; personalize via variable_map.order
    // no agendamento para escolher só as tags que quiser.
    // Dica: para template Meta com um único {{1}}, use variable_map.order = ['resumo_completo'].
    resumo_geral: [
          'data_geracao',                    // {{1}}
          'ev_mes_referencia',               // {{2}}
          'ev_total',                        // {{3}}
          ...
          'ev_outros',                       // {{7}}
          'ev_cidade_top',                   // {{8}}
          'ev_cooperativa_top',              // {{9}}
          'cob_percentual_inadimplencia',    // {{10}}
          'cob_total_gerados',               // {{11}}
          'cob_total_baixados',              // {{12}}
          'cob_faturamento_esperado',        // {{13}}
          'cob_faturamento_recebido',        // {{14}}
          'cob_total_aberto',                // {{15}}
          'cob_coop_maior_inadimplencia',    // {{16}}
          'cob_coop_menor_inadimplencia',    // {{17}}
          'mgf_total_lancamentos',           // {{18}}
          'mgf_valor_total',                 // {{19}}
          'mgf_pagos',                       // {{20}}
          'mgf_em_aberto',                   // {{21}}
          'mgf_top_operacao',                // {{22}}
