...
async function rodarRobo() {
  ...
  try {
    ...
    await page.waitForTimeout(1000);
    // MGF: apos selecionar o layout, o relatorio ja pode ser gerado.
    // NAO existe etapa de "Centro de Custo / Departamento" no relatorio de
    // lancamentos financeiros — isso era heranca do fluxo de Eventos e so fazia
    // o robo perder tempo procurando checkbox inexistente. Pulando direto.
    await page.waitForTimeout(500);
