...
export function AndamentosDialog({ 
  ...
  const [emailDialog, setEmailDialog] = useState<{ open: boolean; andamento: Andamento | null }>({ open: false, andamento: null });
                          ...
                          <div className="flex items-start justify-between mb-3 gap-3">
                            <div className="flex-1 space-y-2">
                              ...
                              <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                                ...
                                {format(new Date(andamento.created_at), "dd 'de' MMMM 'de' yyyy 'às' HH:mm", { locale: ptBR })}
                              </div>
                            </div>
                            {mode === 'edit' && (
                              <Button
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2 justify-end pt-2">
              <Button 
                variant="outline" 
                onClick={() => setEmailDialog({ open: false, andamento: null })}
              >
                Cancelar
              </Button>
              <Button 
