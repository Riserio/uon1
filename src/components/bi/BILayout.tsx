...
type BIModule = 'indicadores' | 'eventos' | 'mgf' | 'cobranca' | 'estudo-base' | 'cadastro' | 'acompanhamento-eventos' | 'admin';
...
const titleMap: Record<BIModule, { title: string; subtitle: string }> = {
  ...
  cadastro: { title: 'BI - Cadastro', subtitle: 'Business Intelligence de Cadastro de Associados' },
