...
const TAGS_BY_TYPE: Record<string, { tag: string; descricao: string }[]> = {
  ...
  // Ordem alinhada 1:1 com as variáveis {{1}}..{{11}} do template aprovado na
  // Meta — clique nas tags nesta ordem para montar o corpo corretamente.
  geral: [
    { tag: "{nome_associacao}", descricao: "{{1}} Nome da associação" },
    { tag: "{data_atual}", descricao: "{{2}} Data/mês de referência" },
    { tag: "{faturamento_esperado}", descricao: "{{3}} Faturamento previsto" },
    { tag: "{faturamento_recebido}", descricao: "{{4}} Faturamento recebido" },
    { tag: "{total_aberto}", descricao: "{{5}} Valor em aberto" },
    { tag: "{total_gerados}", descricao: "{{6}} Boletos gerados" },
    { tag: "{total_baixados}", descricao: "{{7}} Boletos baixados" },
    { tag: "{percentual_inadimplencia}", descricao: "{{8}} Percentual de inadimplência" },
    { tag: "{total_eventos}", descricao: "{{9}} Total de eventos" },
    { tag: "{cooperativa_maior_inadimplencia}", descricao: "{{10}} Maior inadimplência" },
    { tag: "{cidade_mais_eventos}", descricao: "{{11}} Cidade com mais eventos" },
  ],
  manual: [
    { tag: "{nome_associacao}", descricao: "Nome da associação" },
    { tag: "{data_atual}", descricao: "Data atual" },
