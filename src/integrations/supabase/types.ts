  ...
  public: {
    Tables: {
      ...
      ausencias_funcionario: {
        ...
        Relationships: [
          {
            foreignKeyName: "ausencias_funcionario_funcionario_id_fkey"
            columns: ["funcionario_id"]
            isOneToOne: false
            referencedRelation: "funcionarios"
            referencedColumns: ["id"]
      ...
      whatsapp_contact_flow_state: {
        ...
        Relationships: [
          {
            foreignKeyName: "whatsapp_contact_flow_state_contact_id_fkey"
            columns: ["contact_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "whatsapp_contact_flow_state_flow_id_fkey"
            columns: ["flow_id"]
            isOneToOne: false
            referencedRelation: "whatsapp_flows"
            referencedColumns: ["id"]
      ...
      whatsapp_contacts: {
        ...
        Relationships: [
          {
            foreignKeyName: "whatsapp_contacts_assigned_to_fkey"
            columns: ["assigned_to"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "whatsapp_contacts_corretora_id_fkey"
            columns: ["corretora_id"]
            isOneToOne: false
            referencedRelation: "corretoras"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "whatsapp_contacts_human_mode_by_fkey"
            columns: ["human_mode_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
    ...
    Functions: {
      ...
      calcular_sinistralidade_volume: {
        Args: { p_corretora_id: string }
        Returns: Json
      }
