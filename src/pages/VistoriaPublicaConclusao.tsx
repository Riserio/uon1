...
import { CheckCircle2, Clock, Mail, Phone, Shield, Sparkles, FileCheck, Award } from "lucide-react";
        ...
        <Card className="border-none shadow-2xl overflow-hidden mb-8">
          ...
          <div className="bg-gradient-to-r from-green-500 to-emerald-600 p-12 text-center text-white relative overflow-hidden">
            ...
            {corretora?.logo_url && (
              <div className="relative bg-white rounded-2xl p-6 inline-block mb-8 shadow-xl">
                <img src={corretora.logo_url} alt={corretora.nome} className="h-14 object-contain" />
              </div>
            )}
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-4 leading-tight">Vistoria Concluída!</h1>
          ...
          <CardContent className="p-8 md:p-12 space-y-8">
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-8 rounded-2xl border-2 border-green-200 text-center">
              ...
              <p className="text-5xl md:text-6xl font-bold text-green-700">#{vistoria?.numero}</p>
              ...
              <div className="space-y-6 ml-2">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div className="flex-1 pt-1">
                    ...
                    <p className="text-gray-600">Nossa equipe de especialistas validará a análise em até 24h úteis</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div className="flex-1 pt-1">
                    ...
                    <p className="text-gray-600">Entraremos em contato com o resultado e próximos passos</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-2xl p-8 text-center shadow-xl">
              ...
              <p className="font-bold text-2xl mb-2">Tudo Certo!</p>
