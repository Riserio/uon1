...
const BRAZILIAN_CITIES: { [key: string]: [number, number] } = {
  ...
  "SOBRADINHO": [-47.7897, -15.6519], "SANTA MARIA DF": [-48.0100, -16.0183], "SAO SEBASTIAO DF": [-47.7722, -15.9053],
  ...
  "LAGO NORTE": [-47.8333, -15.7333], "CRUZEIRO DF": [-47.9333, -15.8000], "JARDIM BOTANICO": [-47.8167, -15.8833],
};
