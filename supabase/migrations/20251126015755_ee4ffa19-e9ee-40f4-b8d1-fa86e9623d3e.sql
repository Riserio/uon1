-- Melhorar trigger de sincronização bidirecional entre vistorias e atendimentos
-- Este trigger garante que TODOS os dados preenchidos em vistorias sejam refletidos nos atendimentos
