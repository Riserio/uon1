      ...
      <div className="container mx-auto px-4 sm:px-6 py-6">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <div className="w-full overflow-x-auto pb-2">
            <TabsList className="inline-flex md:flex md:w-auto gap-1 p-1.5 bg-transparent border border-rose-500/30 rounded-xl min-w-max md:min-w-0 shadow-sm shadow-rose-500/10">
              {tabs.map((tab) => {
                const Icon = tab.icon;
                return (
                  <TabsTrigger
                    ...
                    className="flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium
                               ...
                               data-[state=active]:bg-transparent data-[state=active]:text-rose-600
                               data-[state=active]:border-rose-500/60 data-[state=active]:shadow-sm data-[state=active]:shadow-rose-500/20
                               hover:text-rose-600 hover:bg-rose-500/5
                               whitespace-nowrap"
                  >
