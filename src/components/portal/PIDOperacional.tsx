...
export default function PIDOperacional({ corretoraId }: { corretoraId?: string }) {
  ...
  const calculatedData = useMemo(() => {
    ...
    const percentual_arrecadacao_juros = data.arrecadamento_juros && totalRecebido ? (data.arrecadamento_juros / totalRecebido) * 100 : 0;
    const percentual_descontado_banco = data.descontado_banco && totalRecebido ? (data.descontado_banco / totalRecebido) * 100 : 0;
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      // Filtrar apenas os campos que existem na tabela pid_operacional
      const saveData = {
        corretora_id: corretoraId,
        ano: parseInt(ano),
        mes: parseInt(mes),
        updated_by: user.id,
        // Movimentação de Base
        placas_ativas: calculatedData.placas_ativas || 0,
        total_cotas: calculatedData.total_cotas || 0,
        total_associados: calculatedData.total_associados || 0,
        cadastros_realizados: calculatedData.cadastros_realizados || 0,
        indice_crescimento_bruto: calculatedData.indice_crescimento_bruto || 0,
        cancelamentos: calculatedData.cancelamentos || 0,
        inadimplentes: calculatedData.inadimplentes || 0,
        reativacao: calculatedData.reativacao || 0,
        churn: calculatedData.churn || 0,
        saldo_placas: calculatedData.saldo_placas || 0,
        percentual_inadimplencia: calculatedData.percentual_inadimplencia || 0,
        percentual_cancelamentos: calculatedData.percentual_cancelamentos || 0,
        percentual_adesoes: calculatedData.percentual_adesoes || 0,
        crescimento_liquido: calculatedData.crescimento_liquido || 0,
        // Indicadores Financeiros
        boletos_emitidos: calculatedData.boletos_emitidos || 0,
        boletos_liquidados: calculatedData.boletos_liquidados || 0,
        boletos_abertos: calculatedData.boletos_abertos || 0,
        boletos_cancelados: calculatedData.boletos_cancelados || 0,
        faturamento_operacional: calculatedData.faturamento_operacional || 0,
        total_recebido: calculatedData.total_recebido || 0,
        baixado_pendencia: calculatedData.baixado_pendencia || 0,
        valor_boletos_abertos: calculatedData.valor_boletos_abertos || 0,
        valor_boletos_cancelados: calculatedData.valor_boletos_cancelados || 0,
        recebimento_operacional: calculatedData.recebimento_operacional || 0,
        arrecadamento_juros: calculatedData.arrecadamento_juros || 0,
        descontado_banco: calculatedData.descontado_banco || 0,
        percentual_emissao_boleto: calculatedData.percentual_emissao_boleto || 0,
        percentual_inadimplencia_boletos: calculatedData.percentual_inadimplencia_boletos || 0,
        percentual_cancelamento_boletos: calculatedData.percentual_cancelamento_boletos || 0,
        ticket_medio_boleto: calculatedData.ticket_medio_boleto || 0,
        percentual_inadimplencia_financeira: calculatedData.percentual_inadimplencia_financeira || 0,
        percentual_arrecadacao_juros: calculatedData.percentual_arrecadacao_juros || 0,
        percentual_descontado_banco: calculatedData.percentual_descontado_banco || 0,
        percentual_crescimento_faturamento: calculatedData.percentual_crescimento_faturamento || 0,
        percentual_crescimento_recebido: calculatedData.percentual_crescimento_recebido || 0,
        // Eventos
        abertura_indenizacao_parcial_associado: calculatedData.abertura_indenizacao_parcial_associado || 0,
        abertura_indenizacao_parcial_terceiro: calculatedData.abertura_indenizacao_parcial_terceiro || 0,
        abertura_indenizacao_integral_associado: calculatedData.abertura_indenizacao_integral_associado || 0,
        abertura_indenizacao_integral_terceiro: calculatedData.abertura_indenizacao_integral_terceiro || 0,
        abertura_vidros: calculatedData.abertura_vidros || 0,
        abertura_carro_reserva: calculatedData.abertura_carro_reserva || 0,
        abertura_total_eventos: calculatedData.abertura_total_eventos || 0,
        pagamento_qtd_parcial_associado: calculatedData.pagamento_qtd_parcial_associado || 0,
        pagamento_qtd_parcial_terceiro: calculatedData.pagamento_qtd_parcial_terceiro || 0,
        pagamento_qtd_integral_associado: calculatedData.pagamento_qtd_integral_associado || 0,
        pagamento_qtd_integral_terceiro: calculatedData.pagamento_qtd_integral_terceiro || 0,
        pagamento_qtd_vidros: calculatedData.pagamento_qtd_vidros || 0,
        pagamento_qtd_carro_reserva: calculatedData.pagamento_qtd_carro_reserva || 0,
        pagamento_valor_parcial_associado: calculatedData.pagamento_valor_parcial_associado || 0,
        pagamento_valor_parcial_terceiro: calculatedData.pagamento_valor_parcial_terceiro || 0,
        pagamento_valor_integral_associado: calculatedData.pagamento_valor_integral_associado || 0,
        pagamento_valor_integral_terceiro: calculatedData.pagamento_valor_integral_terceiro || 0,
        pagamento_valor_vidros: calculatedData.pagamento_valor_vidros || 0,
        pagamento_valor_carro_reserva: calculatedData.pagamento_valor_carro_reserva || 0,
        custo_total_eventos: calculatedData.custo_total_eventos || 0,
        ticket_medio_parcial: calculatedData.ticket_medio_parcial || 0,
        ticket_medio_integral: calculatedData.ticket_medio_integral || 0,
        ticket_medio_vidros: calculatedData.ticket_medio_vidros || 0,
        ticket_medio_carro_reserva: calculatedData.ticket_medio_carro_reserva || 0,
        indice_dano_parcial: calculatedData.indice_dano_parcial || 0,
        indice_dano_integral: calculatedData.indice_dano_integral || 0,
        sinistralidade_financeira: calculatedData.sinistralidade_financeira || 0,
        sinistralidade_geral: calculatedData.sinistralidade_geral || 0,
        // Assistência
        acionamentos_assistencia: calculatedData.acionamentos_assistencia || 0,
        custo_assistencia: calculatedData.custo_assistencia || 0,
        comprometimento_assistencia: calculatedData.comprometimento_assistencia || 0,
        // Rastreamento
        veiculos_rastreados: calculatedData.veiculos_rastreados || 0,
        instalacoes_rastreamento: calculatedData.instalacoes_rastreamento || 0,
        custo_rastreamento: calculatedData.custo_rastreamento || 0,
        comprometimento_rastreamento: calculatedData.comprometimento_rastreamento || 0,
        // Rateio
        custo_total_rateavel: calculatedData.custo_total_rateavel || 0,
        rateio_periodo: calculatedData.rateio_periodo || 0,
        percentual_rateio: calculatedData.percentual_rateio || 0,
        cme_explit: calculatedData.cme_explit || 0,
      };
