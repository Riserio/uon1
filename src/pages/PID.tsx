              ...
              <div className="flex flex-col sm:flex-row justify-between gap-4 items-start sm:items-center">
                <div className="flex items-center gap-4 flex-1">
                  ...
                  <Select value={selectedCorretora} onValueChange={setSelectedCorretora} disabled={loading}>
                    <SelectTrigger id="corretora-select" className="w-full sm:max-w-md h-12 border-2 text-base">
          ...
          <TabsList className="grid w-full grid-cols-3 lg:grid-cols-6 rounded-xl bg-muted/30 p-1.5 shadow-sm">
            <TabsTrigger
              ...
              className="group flex items-center justify-center gap-2 rounded-lg px-3 py-2.5 
                         text-xs sm:text-sm font-medium text-muted-foreground transition-all
